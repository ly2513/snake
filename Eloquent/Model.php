...
abstract class Model implements \ArrayAccess, \Support\Arrayable, \JsonSerializable
{
    /**
    ...
    public function push()
    {
        ...
        foreach ($this->relations as $models) {
            $models = $models instanceof \Support\Collection ? $models->all() : [$models];
    ...
    protected function newBaseQueryBuilder()
    {
        ...
        return new \Database\Builder($connection, $connection->getQueryGrammar(), $connection->getPostProcessor());
    }
    ...
    {
        return new \Support\Collection($models);
    }
    ...
    {
        return $using ? $using::fromRawAttributes($parent, $attributes, $table, $exists) : new Pivot($parent,
