...
use Snake\Database\Eloquent\Relations\Concerns\SupportsDefaultModels;

/**
 * @mixin \Snake\Database\Eloquent\Builder
 */
class BelongsTo extends Relation
{
     ...
     *
     * @param  \Snake\Database\Eloquent\Model|int|string  $model
