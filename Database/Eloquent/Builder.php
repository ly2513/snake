...
/**
 * @mixin \Snake\Database\Query\Builder
 */
class Builder
{
     ...
     *
     * @var \Snake\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Snake\Database\Eloquent\Model
     */
    protected $model;
     ...
     * @param  \Snake\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Snake\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Snake\Database\Eloquent\Model|\Snake\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param  \Snake\Contracts\Support\Arrayable|array  $ids
     * @param  array  $columns
     * @return \Snake\Database\Eloquent\Collection
     */
    ...
    public function firstOrCreate(array $attributes, array $values = [])
    {
        ...
        return \Snake\Support\Arr::tap($this->newModelInstance($attributes + $values), function ($instance) {
            $instance->save();
        });
    }
     ...
     *
     * @param  array  $columns
     * @return \Snake\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \Snake\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \Snake\Database\Eloquent\Model|$this
     */
    public function create(array $attributes = [])
    {
        return \Snake\Support\Arr::tap($this->newModelInstance($attributes), function ($instance) {
            $instance->save();
        });
    }
