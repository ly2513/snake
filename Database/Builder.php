...
class Builder
{
    ...
    /**
     * The database QueryGrammar instance.
     *
     * @var
     */
    public $grammar;
     ...
     * @param QueryGrammar|null   $grammar
    ...
    {
        $join = new \Database\JoinClause($this, $type, $table);
    ...
    public function crossJoin($table, $first = null, $operator = null, $second = null)
    {
        ...
        $this->joins[] = new \Database\JoinClause($this, 'cross', $table);
    ...
    public function whereIn($column, $values, $boolean = 'and', $not = false)
    {
        ...
        if ($values instanceof \Support\Arrayable) {
    ...
    public function groupBy(...$groups)
    {
        foreach ($groups as $group) {
            $v            = !is_array($group) ? [$group] : $group;
            $this->groups = array_merge((array)$this->groups, $v);
        }
    ...
    public function get($columns = ['*'])
    {
        ...
        return new \Support\Collection($results);
    }
    ...
    {
        return Arr::tap(clone $this, function ($clone) use ($except) {
