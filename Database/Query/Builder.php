<?php
namespace Snake\Database\Query;
...
use Snake\Database\ConnectionInterface;
use Snake\Database\Query\Grammars\Grammar;
use Snake\Database\Query\Processors\Processor;
use Snake\Database\Eloquent\Builder as EloquentBuilder;
...
class Builder
{
     ...
     *
     * @var \Snake\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @param  \Snake\Database\ConnectionInterface        $connection
     ...
     *
     * @return \Snake\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Snake\Database\Query\Builder|string $query
     * @param  string                                        $as
     *
     * @return \Snake\Database\Query\Builder|static
     *
     ...
     *
     * @param  string                               $column
     * @param  \Snake\Database\Query\Builder|static $query
     * @param  string                               $boolean
     * @param  bool                                 $not
     *
     * @return $this
     ...
     * Add an exists clause to the query.
     *
     * @param  \Snake\Database\Query\Builder $query
     * @param  string                        $boolean
     * @param  bool                          $not
     *
     * @return $this
     ...
     *
     * @param  \Snake\Database\Query\Builder|\Closure $query
     * @param  bool                                   $all
     *
     * @return \Snake\Database\Query\Builder|static
     */
    ...
    public function get($columns = ['*'])
    {
        ...
        return new \Snake\Support\Collection($results);
    }
    ...
    {
        return $this->cloneWithout(['columns', 'orders', 'limit', 'offset'])->cloneWithoutBindings([
                'select',
                'order'
     ...
     *
     * @return \Snake\Database\ConnectionInterface
     */
    ...
    {
        return \Snake\Support\Arr::tap(clone $this, function ($clone) use ($properties) {
    ...
    {
        return \Snake\Support\Arr::tap(clone $this, function ($clone) use ($except) {
     ...
     * @param  array $columns
     *
     * @return \Snake\Database\Eloquent\Model|static|null
     */
