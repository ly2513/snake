...
class Builder
{
    ...
    {
        $this->build($this->tap($this->createBlueprint($table), function ($blueprint) use ($callback) {
            $blueprint->create();
            $callback($blueprint);
        }));
    }
    ...
    {
        $this->build($this->tap($this->createBlueprint($table), function ($blueprint) {
            $blueprint->drop();
        }));
    }
    ...
    {
        $this->build($this->tap($this->createBlueprint($from), function ($blueprint) use ($to) {
            $blueprint->rename($to);
        }));
    }
